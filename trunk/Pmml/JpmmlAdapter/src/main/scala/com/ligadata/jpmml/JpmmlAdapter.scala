 ...
 *
 * @param modelContext The runtime model context containing the message, transaction info, et al
 ...
 * @param modelName The modelnamespace.modelname of the model instance
 * @param modelVersion The model version of this model instance
 * @param isInstanceReusable When true, the engine will cache the instance of this model
 */
class JpmmlAdapter( modelContext: ModelContext
                    , factory : ModelBaseObj
                    , modelEvaluator: ModelEvaluator[_]
                    , modelName : String
                    , modelVersion : String
                    , isInstanceReusable : Boolean)
        extends ModelBase(modelContext,factory,modelName, modelVersion, isInstanceReusable, 0) {
...
object JpmmlAdapter extends ModelBaseObj {
     ...
     * @param modelName the specific name of the model to be created
     * @param modelVersion the specific version of the model to be created
     * @return - an instance of the Model that can process the message found in the ModelContext
     */
    def CreateNewModel(mCtx: ModelContext, modelName : String, modelVersion : String): ModelBase = {
        ...
        val modelVer : String = modelVersion.toString
        ...
        val useThisModel : ModelBase = if (model != null) {
            ...
            if (modelDef != null) {
                ...
                val builtModel : ModelBase = new JpmmlAdapter( mCtx, this, modelEvaluator, modelName, modelVersion, isInstanceReusable)
