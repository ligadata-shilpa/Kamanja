...
object ConfigDefaults {
  ...
  def envContextDependecyJarList: List[String] = List(s"ExtDependencyLibs_$scalaVersion-1.4.2.jar", s"KamanjaInternalDeps_$scalaVersion-1.4.2.jar", s"ExtDependencyLibs2_$scalaVersion-1.4.2.jar")
  def envContextJarName = s"simpleenvcontextimpl_$scalaVersion-1.0.jar"

  def nodeClassPath: String = s".:$jarResourceDir/ExtDependencyLibs_$scalaVersion-1.4.2.jar:$jarResourceDir/KamanjaInternalDeps_$scalaVersion-1.4.2.jar:$jarResourceDir/ExtDependencyLibs2_$scalaVersion-1.4.2.jar"

  def adapterDepJars: List[String] = List(s"ExtDependencyLibs_$scalaVersion-1.4.2.jar", s"KamanjaInternalDeps_$scalaVersion-1.4.2.jar", s"ExtDependencyLibs2_$scalaVersion-1.4.2.jar")
  ...
  val metadataClasspath: String = List(
    s"ExtDependencyLibs_$scalaVersion-1.4.2.jar",
    s"KamanjaInternalDeps_$scalaVersion-1.4.2.jar",
    s"ExtDependencyLibs2_$scalaVersion-1.4.2.jar"
