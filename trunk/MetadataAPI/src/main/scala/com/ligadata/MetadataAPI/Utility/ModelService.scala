...
object ModelService {
   ...
   */
  def addModelScala(input: String, dep: String = "", userid: Option[String] = Some("kamanja"), optMsgProduced: Option[String] = None, tid: Option[String] = None): String = {
   ...
   */
  def addModelPmml(modelType: ModelType.ModelType, input: String, optUserid: Option[String] = Some("kamanja"), optModelName: Option[String] = None, optVersion: Option[String] = None, optMsgConsumed: Option[String] = None, optMsgVersion: Option[String] = Some("-1"), tid: Option[String] = None): String = {
  ...
  def addModelPython(modelType: ModelType.ModelType, input: String, optUserid: Option[String] = Some("kamanja"), optModelName: Option[String] = None, optVersion: Option[String] = None, optMsgConsumed: Option[String] = None, optMsgVersion: Option[String] = Some("-1"), tid: Option[String] = None): String = {
    ...
    val response: String = if (input == "") {
      ...
      val resp: String = if (model.exists()) {
        val modelDef = Source.fromFile(model).mkString
        MetadataAPIImpl.AddModel(ModelType.PYTHON, modelDef, optUserid, finalTid, optModelName, optVersion, optMsgConsumed, None, optMsgVersion)
      } else {
        val userId: String = optUserid.getOrElse("no user id supplied")
        val modelName: String = optModelName.getOrElse("no model name supplied")
        val version: String = optVersion.getOrElse("no version supplied")
   ...
   * @return result string from engine describing success or failure
   */
  def addModelJython(modelType: ModelType.ModelType, input: String, optUserid: Option[String] = Some("kamanja"), optModelName: Option[String] = None, optVersion: Option[String] = None, optMsgConsumed: Option[String] = None, optMsgVersion: Option[String] = Some("-1"), tid: Option[String] = None): String = {
    ...
    val response: String = if (input == "") {
      ...
      val resp: String = if (model.exists()) {
        val modelDef = Source.fromFile(model).mkString
        MetadataAPIImpl.AddModel(ModelType.JYTHON, modelDef, optUserid, finalTid, optModelName, optVersion, optMsgConsumed, None, optMsgVersion)
      } else {
        val userId: String = optUserid.getOrElse("no user id supplied")
        val modelName: String = optModelName.getOrElse("no model name supplied")
        val version: String = optVersion.getOrElse("no version supplied")
   ...
   * @return the result of the operation
   */
  def addModelKPmml(input: String, userid: Option[String] = Some("kamanja"), optMsgProduced: Option[String] = None, tid: Option[String] = None): String = {
    var modelDef = ""
    var modelConfig = ""
    var response: String = ""
    var modelFileDir: String = ""
   ...
   */
  def updateModelPmml(pmmlPath: String, userid: Option[String], modelNamespaceName: String, newVersion: String, tid: Option[String] = None): String = {
  ...
  def updateModelPython(pythonModelPath: String, userid: Option[String], modelNamespaceName: String, newVersion: String, tid: Option[String] = None): String = {
    ...
    val response: String = try {
      ...
      MetadataAPIImpl.UpdateModel(ModelType.PYTHON, pythonMdlText, userid, finalTid, Some(modelNamespaceName), Some(newVersion), None, None)
    } catch {
      case fnf: FileNotFoundException => {
  ...
  def updateModelJython(jythonModelPath: String, userid: Option[String], modelNamespaceName: String, newVersion: String, tid: Option[String] = None): String = {
    ...
    val response: String = try {
      ...
      MetadataAPIImpl.UpdateModel(ModelType.JYTHON, jythonMdlText, userid, finalTid, Some(modelNamespaceName), Some(newVersion), None, None)
    } catch {
      case fnf: FileNotFoundException => {
   ...
   * @return the result of the operation
   */
  def updateModeljava(input: String, dep: String = "", userid: Option[String] = Some("kamanja"), tid: Option[String] = None): String = {
    var modelDef = ""
    var modelConfig = ""
    var response: String = ""
    var modelFileDir: String = ""
   ...
   * @return the result of the operation
   */
  def updateModelscala(input: String, dep: String = "", userid: Option[String] = Some("kamanja"), tid: Option[String] = None): String = {
    var modelDef = ""
    var modelConfig = ""
    var response: String = ""
    var modelFileDir: String = ""
   ...
   */
  def getModel(param: String = "", userid: Option[String] = Some("kamanja")): String = {
    var response = ""
    try {
      if (param.length > 0) {
   ...
   * @return the result of the operation
   */
  def removeModel(modelId: String = "", userid: Option[String] = Some("kamanja")): String = {
    val response: String = try {
   ...
   * @return the result of the operation
   */
  def deactivateModel(modelId: String = "", userid: Option[String] = Some("kamanja")): String = {
    var response = ""
