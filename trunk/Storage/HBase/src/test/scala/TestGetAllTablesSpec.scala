...
@Ignore
class TestGetAllTablesSpec extends FunSpec with BeforeAndAfter with BeforeAndAfterAll with GivenWhenThen {
  ...
  describe("Unit Tests for getAllTables") {
