...
object msg1 extends RDDObject[msg1] with MessageFactoryInterface {
  ...
  override def getTimePartitionInfo: TimePartitionInfo = { return null;}  // FieldName, Format & Time Partition Types(Daily/Monthly/Yearly)
    ...
    override def convertFrom(newVerObj: Any, oldVerobj: Any): ContainerInterface = {
      ...
      case oldVerobj: com.ligadata.kamanja.Testmsg.msg1 => { return  convertToVer1000000(oldVerobj); }
          case _ => {
    ...
    private def convertToVer1000000(oldVerobj: com.ligadata.kamanja.Testmsg.msg1): com.ligadata.kamanja.Testmsg.msg1= {
      return oldVerobj
    }
