package com.ligadata.kamanja.Testmsg;
...
object msg2 extends RDDObject[msg2] with MessageFactoryInterface {
  ...
  override def getTimePartitionInfo: TimePartitionInfo = { return null;}  // FieldName, Format & Time Partition Types(Daily/Monthly/Yearly)
    ...
    override def getAvroSchema: String = """{ "type": "record",  "namespace" : "com.ligadata.kamanja.Testmsg" , "name" : "msg2" , "fields":[{ "name" : "in1" , "type" : "int"},{ "name" : "in2" , "type" : "int"},{ "name" : "in3" , "type" : "int"}]}""";
    ...
    override def convertFrom(newVerObj: Any, oldVerobj: Any): ContainerInterface = {
      ...
      case oldVerobj: com.ligadata.kamanja.Testmsg.msg2 => { return  convertToVer1000000(oldVerobj); }
          case _ => {
    ...
    private def convertToVer1000000(oldVerobj: com.ligadata.kamanja.Testmsg.msg2): com.ligadata.kamanja.Testmsg.msg2= {
      return oldVerobj
    }
...
class msg2(factory: MessageFactoryInterface, other: msg2) extends MessageInterface(factory) {
  ...
  val log = msg2.log
      ...
      try{
        index match {
				...
				if(value.isInstanceOf[Int])
				 ...
				 else throw new Exception(s"Value is the not the correct type for field in1 in message msg2")
				}
				case 1 => {
				if(value.isInstanceOf[Int])
				  this.in2 = value.asInstanceOf[Int];
				 else throw new Exception(s"Value is the not the correct type for field in2 in message msg2")
				}
				case 2 => {
				if(value.isInstanceOf[Int])
				  this.in3 = value.asInstanceOf[Int];
				 else throw new Exception(s"Value is the not the correct type for field in3 in message msg2")
				}
    ...
    private def fromFunc(other: msg2): msg2 = {
	 ...
	 def within1(value: Int) : msg2 = {
		 this.in1 = value
		 return this
 	 }
	 def within2(value: Int) : msg2 = {
		 this.in2 = value
		 return this
 	 }
	 def within3(value: Int) : msg2 = {
		 this.in3 = value
		 return this
 	 }
