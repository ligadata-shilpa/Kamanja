...
*/
    ...
    val supportsInstanceSerialization : Boolean = false
    */
    new ModelDef(ModelRepresentation.UNKNOWN, MiningModelType.UNKNOWN, Array[Array[MessageAndAttributes]](), Array[String](), isReusable, supportsInstanceSerialization)
  }
}
