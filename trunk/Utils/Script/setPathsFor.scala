 ...
 * Example:
 *
 *  setPathsFor.scala --installDir /tmp/drdigital/KamanjaInstall-1.4.2_2.11 --templateFile ClusterConfig.1.4.2.json --scalaHome `which scala` --javaHome `which java` >/tmp/clusterconfig.json 
 *
