...
*/
  ...
  private def DepJars(depJars1: List[String]): List[String] = {
    ...
    if (_fromScalaVersion.equalsIgnoreCase("2.10") && _toScalaVersion.equalsIgnoreCase("2.11")) {
      ...
      newDeps = List("ExtDependencyLibs_2.11-1.4.2.jar", "KamanjaInternalDeps_2.11-1.4.2.jar", "ExtDependencyLibs2_2.11-1.4.2.jar") ::: newDeps
	...
	newDeps = List("ExtDependencyLibs_2.10-1.4.2.jar", "KamanjaInternalDeps_2.10-1.4.2.jar", "ExtDependencyLibs2_2.10-1.4.2.jar") ::: newDeps
      }
      newDeps
    }
  }
