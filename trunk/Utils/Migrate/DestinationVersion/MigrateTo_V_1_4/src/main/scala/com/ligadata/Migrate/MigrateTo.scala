...
*/
  ...
  private def DepJars(depJars1: List[String]): List[String] = {
    ...
    val depJars = (depJars1 diff List("methodextractor_2.10-1.0.jar", "methodextractor_2.11-1.0.jar", "log4j-1.2.17.jar", "log4j-1.2.17.jar", "log4j-1.2.16.jar", "scala-2.10.0.jar", "kvbase_2.10-0.1.0.jar", "kamanjautils_2.10-1.0.jar", "kamanjabase_2.10-1.0.jar", "customudflib_2.10-1.0.jar", "pmmlcompiler_2.10-1.0.jar", "basetypes_2.10-0.1.0.jar", "basefunctions_2.10-0.1.0.jar", "json4s-core_2.10-3.2.9.jar", "json4s-jackson_2.10-3.2.9.jar", "pmmlruntime_2.10-1.0.jar", "pmmludfs_2.10-1.0.jar", "datadelimiters_2.10-1.0.jar", "metadata_2.10-1.0.jar", "exceptions_2.10-1.0.jar", "json4s-ast_2.10-3.2.9.jar", "json4s-native_2.10-3.2.9.jar", "bootstrap_2.10-1.0.jar", "messagedef_2.10-1.0.jar", "guava-16.0.1.jar", "guava-18.0.jar", "guava-19.0.jar", "scala-reflect-2.10.4.jar", "scala-library-2.10.4.jar", "jackson-databind-2.3.1.jar", "jackson-core-2.3.1.jar", "joda-time-2.8.2.jar", "jackson-annotations-2.3.0.jar", "joda-convert-1.6.jar", "jsr305-1.3.9.jar", "log4j-api-2.4.1.jar", "log4j-core-2.4.1.jar","methodextractor_2.11-1.0.jar", "methodextractor_2.11-1.0.jar", "log4j-1.2.17.jar", "log4j-1.2.17.jar", "log4j-1.2.16.jar","kvbase_2.11-0.1.0.jar", "kamanjautils_2.11-1.0.jar", "kamanjabase_2.11-1.0.jar", "customudflib_2.11-1.0.jar", "pmmlcompiler_2.11-1.0.jar", "basetypes_2.11-0.1.0.jar", "basefunctions_2.11-0.1.0.jar","json4s-jackson_2.11-3.2.9.jar", "pmmlruntime_2.11-1.0.jar", "pmmludfs_2.11-1.0.jar", "datadelimiters_2.11-1.0.jar", "metadata_2.11-1.0.jar", "exceptions_2.11-1.0.jar", "json4s-ast_2.11-3.2.9.jar", "json4s-native_2.11-3.2.9.jar", "bootstrap_2.11-1.0.jar", "messagedef_2.11-1.0.jar","scalap-2.11.0.jar","scalap-2.10.0.jar","pmml-evaluator-1.2.9.jar","heartbeat_2.11-0.1.0.jar","pmml-model-1.2.9.jar","guava-14.0.1.jar","scala-compiler-2.11.0.jar","commons-math3-3.6.jar","messagedef_2.11-1.0.jar","pmml-schema-1.2.9.jar","pmml-agent-1.2.9.jar","pmmludfs_2.11-1.0.jar","jsr305-3.0.0.jar","scala-library-2.11.7.jar","log4j-1.2-api-2.4.1.jar","log4j-core-2.4.1.jar","basetypes_2.11-0.1.0.jar","bootstrap_2.11-1.0.jar","kamanjautils_2.11-1.0.jar","json4s-core_2.11-3.2.9.jar","jackson-databind-2.3.1.jar","metadata_2.11-1.0.jar","datadelimiters_2.11-1.0.jar","exceptions_2.11-1.0.jar","kamanjabase_2.11-1.0.jar","paranamer-2.6.jar","scala-reflect-2.11.7.jar","jetty-sslengine-6.1.26.jar","jackson-jaxrs-1.8.3.jar","filedataconsumer_2.10-0.1.0.jar","javassist-3.18.1-GA.jar","jcodings-1.0.8.jar","hamcrest-core-1.3.jar","sqlserver_2.10-0.1.0.jar","curator-client-2.7.1.jar","basetypes_2.10-0.1.0.jar","gson-2.3.1.jar","getcomponent_2.10-1.0.jar","shapeless_2.10-1.2.4.jar","scalap-2.10.0.jar","json4s-ast_2.10-3.2.9.jar","jackson-core-asl-1.9.13.jar","asm-commons-4.0.jar","commons-configuration-1.6.jar","junit-4.12.jar","hadoop-annotations-2.7.1.jar","scalatest_2.10-2.2.0.jar","commons-codec-1.10.jar","interfacessamples_2.10-1.0.jar","pmmlcompiler_2.10-1.0.jar","junit-3.8.1.jar","migratefrom_v_1_2_2.10-1.0.jar","jettison-1.1.jar","jsch-0.1.42.jar","redisclient_2.10-2.13.jar","shiro-core-1.2.3.jar","commons-digester-1.8.jar","akka-actor_2.10-2.3.2.jar","jna-3.2.7.jar","netty-all-4.0.23.Final.jar","metadataapiservice_2.10-1.0.jar","servlet-api-2.5.jar","metadataapi_2.10-1.0.jar","logback-classic-1.0.12.jar","hashmap_2.10-0.1.0.jar","pmml-agent-1.2.9.jar","joda-convert-1.7.jar","auditadapters_2.10-1.0.jar","migratebase-1.0.jar","commons-collections4-4.0.jar","antlr-2.7.7.jar","commons-math3-3.1.1.jar","spray-io_2.10-1.3.3.jar","auditadapterbase_2.10-1.0.jar","jetty-util-6.1.26.jar","hbase-protocol-1.0.2.jar","spray-testkit_2.10-1.3.3.jar","chill_2.10-0.5.0.jar","commons-pool-1.6.jar","findbugs-annotations-1.3.9-1.jar","apacheds-i18n-2.0.0-M15.jar","curator-framework-2.7.1.jar","pmmludfs_2.10-1.0.jar","datadelimiters_2.10-1.0.jar","api-util-1.0.0-M20.jar","jaxb-api-2.2.2.jar","xz-1.0.jar","jackson-annotations-2.3.0.jar","transactionservice_2.10-0.1.0.jar","log4j-core-2.4.1.jar","commons-pool-1.5.4.jar","log4j-api-2.4.1.jar","metadataapiserviceclient_2.10-0.1.jar","parboiled-scala_2.10-1.1.7.jar","nodeinfoextract_2.10-1.0.jar","kvbase_2.10-0.1.0.jar","pmmlruntime_2.10-1.0.jar","pmml-model-1.2.9.jar","jsr305-1.3.9.jar","asm-4.0.jar","log4j-1.2-api-2.4.1.jar","metrics-core-2.2.0.jar","slf4j-api-1.7.10.jar","jackson-core-2.3.1.jar","jersey-core-1.9.jar","controller_2.10-1.0.jar","customudflib_2.10-1.0.jar","jackson-databind-2.3.1.jar","lz4-1.2.0.jar","avro-1.7.4.jar","hadoop-common-2.7.1.jar","securityadapterbase_2.10-1.0.jar","gson-2.2.4.jar","cassandra_2.10-0.1.0.jar","zookeeperclient_2.10-1.0.jar","messagedef_2.10-1.0.jar","commons-pool2-2.3.jar","cleanutil_2.10-1.0.jar","zkclient-0.6.jar","zookeeperleaderlatch_2.10-1.0.jar","hbase_2.10-0.1.0.jar","kafka_2.10-0.8.2.2.jar","scala-library-2.10.4.jar","hbase-client-1.0.2.jar","kamanjabase_2.10-1.0.jar","metadata_2.10-1.0.jar","jpmmlfactoryofmodelinstancefactory_2.10-1.0.jar","json4s-jackson_2.10-3.2.9.jar","commons-codec-1.9.jar","filesimpleinputoutputadapters_2.10-1.0.jar","chill-java-0.5.0.jar","spray-http_2.10-1.3.3.jar","scalatest_2.10-2.2.6.jar","spray-util_2.10-1.3.3.jar","scalatest_2.10-2.2.4.jar","spray-can_2.10-1.3.3.jar","curator-recipes-2.7.1.jar","kryo-2.21.jar","json4s-native_2.10-3.2.9.jar","httpcore-4.1.2.jar","serialize_2.10-1.0.jar","commons-codec-1.4.jar","scala-compiler-2.10.4.jar","jersey-server-1.9.jar","jarfactoryofmodelinstancefactory_2.10-1.0.jar","jetty-embedded-6.1.26-sources.jar","activation-1.1.jar","logback-classic-1.0.13.jar","mimepull-1.9.5.jar","commons-io-2.4.jar","jackson-xc-1.8.3.jar","inputoutputadapterbase_2.10-1.0.jar","hadoop-auth-2.7.1.jar","curator-recipes-2.6.0.jar","commons-digester-1.8.1.jar","jets3t-0.9.0.jar","metrics-core-3.0.2.jar","snappy-java-1.0.4.1.jar","simplekafkaproducer_2.10-0.1.0.jar","camel-core-2.9.2.jar","curator-test-2.8.0.jar","pmml-schema-1.2.9.jar","utilsformodels_2.10-1.0.jar","netty-3.9.0.Final.jar","jetty-6.1.26.jar","log4j-1.2.16.jar","xmlenc-0.52.jar","bee-client_2.10-0.28.0.jar","commons-math-2.2.jar","jackson-mapper-asl-1.9.13.jar","spray-client_2.10-1.3.3.jar","servlet-api-2.5.20110712-sources.jar","json-simple-1.1.jar","simpleapacheshiroadapter_2.10-1.0.jar","hbase-common-1.0.2.jar","voldemort-0.96.jar","kvinit_2.10-1.0.jar","jsondatagen_2.10-0.1.0.jar","kamanjautils_2.10-1.0.jar","commons-dbcp2-2.1.jar","spray-httpx_2.10-1.3.3.jar","installdriver_2.10-1.0.jar","json4s-core_2.10-3.2.9.jar","htrace-core-3.1.0-incubating.jar","migrateto_v_1_3_2.10-1.0.jar","java-stub-server-0.12-sources.jar","slf4j-log4j12-1.7.10.jar","stax-api-1.0-2.jar","jersey-json-1.9.jar","akka-actor_2.10-2.3.9.jar","cassandra-driver-core-2.1.2.jar","joda-time-2.9.1.jar","joni-2.1.2.jar","spray-json_2.10-1.3.2.jar","commons-math3-3.6.jar","installdriverbase-1.0.jar","cassandra-thrift-2.0.3.jar","bootstrap_2.10-1.0.jar","commons-lang-2.6.jar","joda-convert-1.6.jar","servlet-api-2.5.20110712.jar","migratefrom_v_1_1_2.10-1.0.jar","objenesis-1.2.jar","commons-beanutils-1.8.3.jar","mapdb-1.0.6.jar","commons-lang3-3.1.jar","kamanjamanager_2.10-1.0.jar","utilityservice_2.10-1.0.jar","commons-compress-1.4.1.jar","commons-collections-3.2.1.jar","outputmsgdef_2.10-1.0.jar","commons-dbcp-1.4.jar","logback-core-1.0.12.jar","scala-reflect-2.10.4.jar","config-1.2.0.jar","joda-time-2.8.2.jar","reflectasm-1.07-shaded.jar","protobuf-java-2.6.0.jar","storagemanager_2.10-0.1.0.jar","hbase-annotations-1.0.2.jar","minlog-1.2.jar","snappy-java-1.1.1.7.jar","scala-compiler-2.10.0.jar","zkclient-0.3.jar","parboiled-core-1.1.7.jar","clusterinstallerdriver-1.0.jar","api-asn1-api-1.0.0-M20.jar","akka-testkit_2.10-2.3.9.jar","zookeeperlistener_2.10-1.0.jar","exceptions_2.10-1.0.jar","commons-logging-1.1.1.jar","commons-beanutils-1.7.0.jar","commons-configuration-1.7.jar","asm-tree-4.0.jar","spray-routing_2.10-1.3.3.jar","logback-core-1.0.13.jar","google-collections-1.0.jar","netty-3.7.0.Final.jar","httpclient-4.2.5.jar","slf4j-log4j12-1.6.1.jar","commons-httpclient-3.1.jar","kafkasimpleinputoutputadapters_2.10-1.0.jar","libthrift-0.9.2.jar","scala-actors-2.10.4.jar","heartbeat_2.10-0.1.0.jar","jsp-api-2.1.jar","jdbcdatacollector_2.10-1.0.jar","basefunctions_2.10-0.1.0.jar","jopt-simple-3.2.jar","pmml-evaluator-1.2.9.jar","curator-client-2.6.0.jar","guava-14.0.1.jar","compress-lzf-0.9.1.jar","java-xmlbuilder-0.4.jar","commons-cli-1.2.jar","jaxb-impl-2.2.3-1.jar","curator-framework-2.6.0.jar","kafka-clients-0.8.2.2.jar","apacheds-kerberos-codec-2.0.0-M15.jar","treemap_2.10-0.1.0.jar","jdom-1.1.jar","storagebase_2.10-1.0.jar","commons-beanutils-core-1.8.0.jar","jsr305-3.0.0.jar","je-4.0.92.jar","zookeeper-3.4.6.jar","simpleenvcontextimpl_2.10-1.0.jar","jsontools-core-1.7-sources.jar","log4j-1.2.17.jar","httpcore-4.2.4.jar","httpclient-4.1.2.jar","jline-0.9.94.jar","commons-logging-1.2.jar","config-1.2.1.jar","asm-3.1.jar","paranamer-2.6.jar","commons-net-3.1.jar"))
