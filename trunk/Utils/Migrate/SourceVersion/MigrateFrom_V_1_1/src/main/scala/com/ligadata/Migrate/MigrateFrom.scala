...
class MigrateFrom_V_1_1 extends MigratableFrom {
  ...
  override def getAllDataObjs(backupTblSufix: String, metadataElemsJson: Array[MetadataFormat], msgsAndContaienrs:java.util.List[String] , callbackFunction: DataObjectCallBack): Unit = {
    if (_bInit == false)
      throw new Exception("Not yet Initialized")
