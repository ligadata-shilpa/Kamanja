...
public interface MigratableFrom {
  ...
  public abstract void getAllDataObjs(String backupTblSufix, MetadataFormat[] orderMetadata, java.util.List<String> msgsAndContaienrs,DataObjectCallBack callbackFunction);
