...
#cp ExtDependencyLibs/target/scala-2.10/ExtDependencyLibs_2.10-1.4.2.jar $kamanjainstallsystemlib
#cp ExtDependencyLibs2/target/scala-2.10/ExtDependencyLibs2_2.10-1.4.2.jar $kamanjainstallsystemlib
#cp KamanjaInternalDeps/target/scala-2.10/KamanjaInternalDeps_2.10-1.4.2.jar $kamanjainstallsystemlib

# copy jars used to reduce package size
cp ExtDependencyLibs/target/scala-2.10/ExtDependencyLibs_2.10-1.4.2.jar $systemlib
cp ExtDependencyLibs2/target/scala-2.10/ExtDependencyLibs2_2.10-1.4.2.jar $systemlib
cp KamanjaInternalDeps/target/scala-2.10/KamanjaInternalDeps_2.10-1.4.2.jar $systemlib
...
cp $srcPath/Utils/Migrate/MigrateBase/target/migratebase-1.4.2.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_1/target/scala-2.10/migratefrom_v_1_1_2.10-1.4.2.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_2/target/scala-2.10/migratefrom_v_1_2_2.10-1.4.2.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_3/target/scala-2.10/migratefrom_v_1_3_2.10-1.4.2.jar $systemlib
# cp $srcPath/Utils/Migrate/DestinationVersion/MigrateTo_V_1_3/target/scala-2.10/migrateto_v_1_3_2.10-1.0.jar $systemlib
cp $srcPath/Utils/Migrate/DestinationVersion/MigrateTo_V_1_4/target/scala-2.10/migrateto_v_1_4_2.10-1.4.2.jar $systemlib
cp $srcPath/Utils/Migrate/GenerateAdapterBindings/target/scala-2.10/generateadapterbindings_2.10-1.4.2.jar $systemlib
...
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_1/target/scala-2.10/migratefrom_v_1_1_2.10-1.4.2.jar $installPath/Kamanja-$ver211/lib/system/
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_2/target/scala-2.10/migratefrom_v_1_2_2.10-1.4.2.jar $installPath/Kamanja-$ver211/lib/system/
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_3/target/scala-2.10/migratefrom_v_1_3_2.10-1.4.2.jar $installPath/Kamanja-$ver211/lib/system/
#cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_1/target/scala-2.10/migratefrom_v_1_1_2.10-1.4.2.jar $installPath/KamanjaInstall-$ver211/lib/system/
#cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_2/target/scala-2.10/migratefrom_v_1_2_2.10-1.4.2.jar $installPath/KamanjaInstall-$ver211/lib/system/
#cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_3/target/scala-2.10/migratefrom_v_1_3_2.10-1.4.2.jar $installPath/KamanjaInstall-$ver211/lib/system/
...
if [ "$buildMigrationLibs" == "yes" ]; then
	...
	mv $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_1/target/scala-2.10/migratefrom_v_1_1_2.10-1.4.2.jar $systemlib
	mv $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_2/target/scala-2.10/migratefrom_v_1_2_2.10-1.4.2.jar $systemlib
	mv $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_3/target/scala-2.10/migratefrom_v_1_3_2.10-1.4.2.jar $systemlib
	mv $srcPath/Utils/Migrate/DestinationVersion/MigrateTo_V_1_4/target/scala-2.10/migrateto_v_1_4_2.10-1.4.2.jar $systemlib
#	mv $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_1/target/scala-2.10/migratefrom_v_1_1_2.10-1.4.2.jar $kamanjainstallsystemlib
#	mv $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_2/target/scala-2.10/migratefrom_v_1_2_2.10-1.4.2.jar $kamanjainstallsystemlib
#	mv $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_3/target/scala-2.10/migratefrom_v_1_3_2.10-1.4.2.jar $kamanjainstallsystemlib
#	mv $srcPath/Utils/Migrate/DestinationVersion/MigrateTo_V_1_4/target/scala-2.10/migrateto_v_1_4_2.10-1.4.2.jar $kamanjainstallsystemlib
...
#cp ExtDependencyLibs/target/scala-2.11/ExtDependencyLibs_2.11-1.4.2.jar $kamanjainstallsystemlib
#cp ExtDependencyLibs2/target/scala-2.11/ExtDependencyLibs2_2.11-1.4.2.jar $kamanjainstallsystemlib
#cp KamanjaInternalDeps/target/scala-2.11/KamanjaInternalDeps_2.11-1.4.2.jar $kamanjainstallsystemlib
cp Utils/PmmlTestTool/target/pmmltesttool* $systemlib
cp Utils/JsonChecker/target/scala-2.11/jsonchecker* $systemlib

# copy jars used to reduce package size
cp ExtDependencyLibs/target/scala-2.11/ExtDependencyLibs_2.11-1.4.2.jar $systemlib
cp ExtDependencyLibs2/target/scala-2.11/ExtDependencyLibs2_2.11-1.4.2.jar $systemlib
cp KamanjaInternalDeps/target/scala-2.11/KamanjaInternalDeps_2.11-1.4.2.jar $systemlib
...
cp $srcPath/Utils/Migrate/DestinationVersion/MigrateTo_V_1_4/target/scala-2.11/migrateto_v_1_4_2.11-1.4.2.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_3/target/scala-2.11/migratefrom_v_1_3_2.11-1.4.2.jar $systemlib
cp $srcPath/Utils/Migrate/GenerateAdapterBindings/target/scala-2.11/generateadapterbindings_2.11-1.4.2.jar $systemlib
...
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_3/target/scala-2.11/migratefrom_v_1_3_2.11-1.4.2.jar $installPath/Kamanja-$ver210/lib/system/
#cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_3/target/scala-2.11/migratefrom_v_1_3_2.11-1.4.2.jar $installPath/KamanjaInstall-$ver210/lib/system/
