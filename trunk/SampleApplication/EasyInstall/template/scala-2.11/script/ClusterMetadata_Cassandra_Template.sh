...
if [ "$1" != "debug" ]; then
	java -Dlog4j.configurationFile=file:{InstallDirectory}/config/log4j.properties -cp {InstallDirectory}/lib/system/jarfactoryofmodelinstancefactory_2.11-1.5.0.jar:{InstallDirectory}/lib/system/ExtDependencyLibs2_2.11-1.5.0.jar:{InstallDirectory}/lib/system/ExtDependencyLibs_2.11-1.5.0.jar:{InstallDirectory}/lib/system/KamanjaInternalDeps_2.11-1.5.0.jar:{InstallDirectory}/lib/system/metadataapi_2.11-1.5.0.jar com.ligadata.MetadataAPI.StartMetadataAPI --config {InstallDirectory}/config/ClusterCfgMetadataAPIConfig_Cassandra.properties
else
