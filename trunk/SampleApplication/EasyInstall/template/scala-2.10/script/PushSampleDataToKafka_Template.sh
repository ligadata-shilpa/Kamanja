...
java -cp $KAMANJA_HOME/lib/system/ExtDependencyLibs-1.0:$KAMANJA_HOME/lib/system/KamanjaInternalDeps-assembly-1.0.jar:$KAMANJA_HOME/bin/SimpleKafkaProducer-0.1.0 --gz true --topics "testin_1" --threads 1 --topicpartitions 8 --brokerlist "localhost:9092" --files $INPUTFILE   --partitionkeyidxs "1" --format CSV
