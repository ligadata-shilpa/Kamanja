...
cp $ivyPath/cache/javax.mail/mail/jars/mail-1.4.jar $systemlib
...
cp $ivyPath/cache/log4j/log4j/jars/log4j-1.2.15.jar $systemlib
...
cp $ivyPath/cache/commons-codec/commons-codec/jars/commons-codec-1.2.jar $systemlib
...
cp $ivyPath/cache/org.slf4j/slf4j-api/jars/slf4j-api-1.7.4.jar $systemlib
