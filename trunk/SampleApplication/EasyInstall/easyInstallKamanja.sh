...
cp $ivyPath/cache/org.scala-lang/scala-library/jars/scala-library-2.10.5.jar $systemlib
...
cp $ivyPath/cache/com.beust/jcommander/jars/jcommander-1.48.jar $systemlib
...
cp $ivyPath/cache/com.fasterxml.jackson.core/jackson-annotations/bundles/jackson-annotations-2.6.0.jar $systemlib
cp $ivyPath/cache/com.fasterxml.jackson.core/jackson-core/bundles/jackson-core-2.3.1.jar $systemlib
cp $ivyPath/cache/com.fasterxml.jackson.core/jackson-core/bundles/jackson-core-2.6.3.jar $systemlib
cp $ivyPath/cache/com.fasterxml.jackson.core/jackson-databind/bundles/jackson-databind-2.3.1.jar $systemlib
cp $ivyPath/cache/com.fasterxml.jackson.core/jackson-databind/bundles/jackson-databind-2.6.3.jar $systemlib
cp $ivyPath/cache/com.github.stephenc.findbugs/findbugs-annotations/jars/findbugs-annotations-1.3.9-1.jar $systemlib
cp $ivyPath/cache/com.github.tony19/named-regexp/jars/named-regexp-0.2.3.jar $systemlib
...
cp $ivyPath/cache/com.google.guava/guava/jars/guava-12.0.1.jar $systemlib
...
cp $ivyPath/cache/com.sun.istack/istack-commons-runtime/jars/istack-commons-runtime-2.21.jar $systemlib
...
cp $ivyPath/cache/com.sun.xml.fastinfoset/FastInfoset/jars/FastInfoset-1.2.13.jar $systemlib
...
cp $ivyPath/cache/javax.xml.bind/jaxb-api/jars/jaxb-api-2.2.12-b140109.1041.jar $systemlib
...
cp $ivyPath/cache/joda-time/joda-time/jars/joda-time-2.9.2.jar $systemlib
cp $ivyPath/cache/joda-time/joda-time/jars/joda-time-2.9.2-javadoc.jar $systemlib
...
cp $ivyPath/cache/org.aicer.grok/grok/jars/grok-0.9.0.jar $systemlib
...
cp $ivyPath/cache/org.jvnet.staxex/stax-ex/jars/stax-ex-1.7.7.jar $systemlib
...
cp $ivyPath/cache/org.rogach/scallop_2.10/jars/scallop_2.10-0.9.5.jar $systemlib
...
cp $ivyPath/cache/org.scoverage/scalac-scoverage-plugin_2.10/jars/scalac-scoverage-plugin_2.10-1.1.1.jar $systemlib
cp $ivyPath/cache/org.scoverage/scalac-scoverage-runtime_2.10/jars/scalac-scoverage-runtime_2.10-1.1.1.jar $systemlib
...
cp $srcPath/GenerateModels/jtm/target/scala-2.10/jtm_2.10-1.0.jar $systemlib
cp $srcPath/GenericMsgCompiler/target/scala-2.10/genericmsgcompiler_2.10-1.0.jar $systemlib
...
cp $srcPath/KamanjaVersion/target/kamanjaversion-1.0.jar $systemlib
...
cp $srcPath/lib_managed/bundles/com.google.guava/guava/guava-14.0.1.jar $systemlib
...
cp $srcPath/lib_managed/bundles/org.apache.logging.log4j/log4j-1.2-api/log4j-1.2-api-2.4.1.jar $systemlib
...
cp $srcPath/lib_managed/jars/com.github.tony19/named-regexp/named-regexp-0.2.3.jar $systemlib
...
cp $srcPath/lib_managed/jars/org.aicer.grok/grok/grok-0.9.0.jar $systemlib
...
cp $srcPath/lib_managed/jars/org.rogach/scallop_2.10/scallop_2.10-0.9.5.jar $systemlib
...
cp $srcPath/lib_managed/jars/org.scoverage/scalac-scoverage-plugin_2.10/scalac-scoverage-plugin_2.10-1.1.1.jar $systemlib
cp $srcPath/lib_managed/jars/org.scoverage/scalac-scoverage-runtime_2.10/scalac-scoverage-runtime_2.10-1.1.1.jar $systemlib
...
cp $srcPath/Utils/CleanUtil/target/scala-2.10/cleanutil_2.10-1.0.jar $systemlib
cp $srcPath/Utils/ClusterInstaller/ClusterInstallerDriver/target/clusterinstallerdriver-1.0.jar $systemlib
cp $srcPath/Utils/ClusterInstaller/GetComponent/target/scala-2.10/getcomponent_2.10-1.0.jar $systemlib
cp $srcPath/Utils/ClusterInstaller/InstallDriverBase/target/installdriverbase-1.0.jar $systemlib
cp $srcPath/Utils/ClusterInstaller/InstallDriver/target/scala-2.10/installdriver_2.10-1.0.jar $systemlib
...
cp $srcPath/Utils/Migrate/MigrateManager/target/migratemanager-1.0.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_1/lib/bootstrap_2.10-1.0.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_1/lib/exceptions_2.10-1.0.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_1/lib/kamanjabase_2.10-1.0.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_1/lib/kamanjadata_2.10-0.1.0.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_1/lib/kamanjautils_2.10-1.0.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_1/lib/log4j-1.2.17.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_1/lib/metadata_2.10-1.0.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_1/lib/metadataapi_2.10-1.0.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_1/lib/serialize_2.10-1.0.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_1/lib/storagebase_2.10-1.0.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_1/lib/storagemanager_2.10-0.1.0.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_1/target/scala-2.10/migratefrom_v_1_1_2.10-1.0.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_2/lib/bootstrap_2.10-1.0.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_2/lib/exceptions_2.10-1.0.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_2/lib/kamanjabase_2.10-1.0.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_2/lib/kamanjautils_2.10-1.0.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_2/lib/kvbase_2.10-0.1.0.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_2/lib/log4j-api-2.4.1.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_2/lib/log4j-core-2.4.1.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_2/lib/metadata_2.10-1.0.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_2/lib/metadataapi_2.10-1.0.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_2/lib/serialize_2.10-1.0.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_2/lib/storagebase_2.10-1.0.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_2/lib/storagemanager_2.10-0.1.0.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_2/target/scala-2.10/migratefrom_v_1_2_2.10-1.0.jar $systemlib
cp $srcPath/Utils/Migrate/SourceVersion/MigrateFrom_V_1_4/target/scala-2.10/migratefrom_v_1_3_2.10-0.1-SNAPSHOT.jar $systemlib
cp $srcPath/Utils/NodeInfoExtract/target/scala-2.10/nodeinfoextract_2.10-1.0.jar $systemlib
cp $srcPath/Utils/PmmlTestTool/target/pmmltesttool-1.0.jar $systemlib
cp $srcPath/Utils/SaveContainerDataComponent/target/scala-2.10/savecontainerdatacomponent_2.10-1.0.jar $systemlib
...
cp $srcPath/Utils/UtilsForModels/target/scala-2.10/utilsformodels_2.10-1.0.jar $systemlib
...
sbt '++ 2.11.7 FileDataConsumer/assembly' '++ 2.11.7 CleanUtil/assembly' '++ 2.11.7 MigrateManager/assembly' '++ 2.11.7 ClusterInstallerDriver/assembly' '++ 2.11.7 InstallDriver/assembly' '++ 2.11.7 GetComponent/assembly' '++ 2.11.7 PmmlTestTool/assembly'
...
cp $ivyPath/cache/org.glassfish.jaxb/jaxb-core/jars/jaxb-core-2.2.11.jar $systemlib
cp $ivyPath/cache/org.glassfish.jaxb/jaxb-runtime/jars/jaxb-runtime-2.2.11.jar $systemlib
cp $ivyPath/cache/org.glassfish.jaxb/txw2/jars/txw2-2.2.11.jar $systemlib
...
cp $ivyPath/cache/org.rogach/scallop_2.11/jars/scallop_2.11-0.9.5.jar $systemlib
...
cp $ivyPath/cache/org.scala-lang/scala-reflect/jars/scala-reflect-2.11.1.jar $systemlib
...
cp $ivyPath/cache/org.scoverage/scalac-scoverage-plugin_2.11/jars/scalac-scoverage-plugin_2.11-1.1.1.jar $systemlib
cp $ivyPath/cache/org.scoverage/scalac-scoverage-runtime_2.11/jars/scalac-scoverage-runtime_2.11-1.1.1.jar $systemlib
...
cp $srcPath/GenerateModels/jtm/target/scala-2.11/jtm_2.11-1.0.jar $systemlib
cp $srcPath/GenericMsgCompiler/target/scala-2.11/genericmsgcompiler_2.11-1.0.jar $systemlib
...
cp $srcPath/lib_managed/bundles/org.scala-lang.modules/scala-parser-combinators_2.11/scala-parser-combinators_2.11-1.0.1.jar $systemlib
cp $srcPath/lib_managed/bundles/org.scala-lang.modules/scala-xml_2.11/scala-xml_2.11-1.0.2.jar $systemlib
...
cp $srcPath/lib_managed/jars/org.rogach/scallop_2.11/scallop_2.11-0.9.5.jar $systemlib
cp $srcPath/lib_managed/jars/org.scala-lang/scala-actors/scala-actors-2.11.7.jar $systemlib
cp $srcPath/lib_managed/jars/org.scala-lang/scala-compiler/scala-compiler-2.11.0.jar $systemlib
...
cp $srcPath/lib_managed/jars/org.scala-lang/scala-reflect/scala-reflect-2.11.2.jar $systemlib
cp $srcPath/lib_managed/jars/org.scoverage/scalac-scoverage-plugin_2.11/scalac-scoverage-plugin_2.11-1.1.1.jar $systemlib
cp $srcPath/lib_managed/jars/org.scoverage/scalac-scoverage-runtime_2.11/scalac-scoverage-runtime_2.11-1.1.1.jar $systemlib
...
cp $srcPath/Utils/ClusterInstaller/GetComponent/target/scala-2.11/getcomponent_2.11-1.0.jar $systemlib
cp $srcPath/Utils/ClusterInstaller/InstallDriver/target/scala-2.11/installdriver_2.11-1.0.jar $systemlib
