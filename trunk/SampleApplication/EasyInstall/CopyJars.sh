...
cp $ivyPath/cache/org.scala-lang/scala-compiler/jars/scala-compiler-2.11.0.jar $systemlib211
cp $ivyPath/cache/org.scala-lang/scala-compiler/jars/scala-compiler-2.11.4.jar $systemlib211
cp $ivyPath/cache/org.scala-lang/scala-compiler/jars/scala-compiler-2.11.5.jar $systemlib211
cp $ivyPath/cache/org.scala-lang/scala-reflect/jars/scala-reflect-2.10.4.jar $systemlib211
cp $ivyPath/cache/org.scalatest/scalatest_2.11/bundles/scalatest*.jar $systemlib211
cp $ivyPath/cache/org.scala-lang/scala-actors/jars/scala-actors-2.11.4.jar $systemlib211
cp $ivyPath/cache/org.scalatest/scalatest_2.11/bundles/scalatest*.jar $systemlib211
...
cp $srcPath/lib_managed/jars/org.scala-lang/scala-compiler/scala-compiler-2.11.4.jar $systemlib211
