...
public class HBaseHelper {
	...
	public void SetConfiguration(String host, String authentication, String masterPrincipal, String regionServer,
		...
		try {
			...
			int isKerberos = authentication.compareToIgnoreCase("kerberos");
			if (isKerberos == 0) {
	...
	public void AskHBase(String host, String authentication, String masterPrincipal, String regionServer,
			String keyType, String principal) throws IOException {
		// HBaseHelper hbase = new HBaseHelper();
		 SetConfiguration(host, authentication, masterPrincipal, regionServer,
		 keyType, principal); // kerberos not tested yet
		//conf(host);
