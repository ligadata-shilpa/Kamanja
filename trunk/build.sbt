...
lazy val MigrateTo_V_1_4_1 = project.in(file("Utils/Migrate/DestinationVersion/MigrateTo_V_1_4_1")).configs(TestConfigs.all: _*).settings(TestSettings.settings: _*).dependsOn(MigrateBase, KamanjaManager, MetadataAPI)
