...
public abstract class AbstractJDBCSink implements BufferedMessageProcessor {
	...
	protected PreparedStatement buildStatementAndParameters(String sqlStr, List<ParameterMapping> paramArray) throws SQLException {
	...
	public void init(AdapterConfiguration config) throws Exception {
		...
		inputFormat = new SimpleDateFormat(config.getProperty(AdapterConfiguration.INPUT_DATE_FORMAT, "yyyy-MM-dd'T'HH:mm:ss.SSS"));
	}
